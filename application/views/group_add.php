				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open_multipart('group/submit', array('id' => 'group-form', 'name' => 'group-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row">
										<label for="group_name" class="col-5 col-form-label"><?php echo $this->lang->line('label_group_name');?></label>
										<div class="col-7">
											<input type="text" class="form-control col-7" id="group_name" name="group_name" value="">
										</div>
									</div>
									<div class="form-group row">
									...
									<?php
										...
										if(sizeof($lang) > 1)
										{
											...
											for($i=2;$i<sizeof($lang);$i++)
											{
												...
												$content_html .= '<input type="text" class="form-control col-7" id="group_name-' . $i . '" name="group_name-' . $i . '" value="">';
												$content_html .= '</div>';
												$content_html .= '</div>';
												$content_html .= '</div>';
											}
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									message = json.msg;
									msg_icon = 1;
									parent.$('#group-table').DataTable().ajax.reload();
									parent.layer.close(index);
								}
								else {
