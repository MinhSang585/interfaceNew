				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							...
							<?php echo form_open('marquee/submit', array('id' => 'marquee-form', 'name' => 'marquee-form', 'class' => 'form-horizontal'));?>
									...
									<?php
...

										{
...

											{
												...
												$content_html .= '<textarea rows="6" class="form-control col-12 summernote" id="marquee_name-' . $v . '" name="marquee_name-' . $v . '" ></textarea>';
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									...
									parent.$('#marquee-table').DataTable().ajax.reload();
