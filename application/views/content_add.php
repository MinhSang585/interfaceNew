				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('content/submit', array('id' => 'content-form', 'name' => 'content-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row mt-3">
										<label for="content_name" class="col-2 col-form-label"><?php echo $this->lang->line('label_content_title'); ?></label>
										<div class="col-10">
											<input type="text" class="form-control" id="content_name" name="content_name" value="">
										</div>
									</div>
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									message = json.msg;
									msg_icon = 1;
									parent.$('#content-table').DataTable().ajax.reload();
									parent.layer.close(index);
								}
								else {
