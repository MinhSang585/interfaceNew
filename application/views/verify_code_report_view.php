					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('report/verify_code_search');?>" id="report-form" name="report-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
									<div class="form-group row">
										...
										<div class="col-md-4">
											<div class="row mb-2">
												<label class="col-4 col-form-label col-form-label-sm font-weight-normal"><?php echo $this->lang->line('label_transaction_code');?></label>
												<div class="col-8">
													<input type="text" class="form-control form-control-sm" id="transaction_id" name="transaction_id" value="">
												</div>
											</div>	
											<div class="row mb-2">
							...
							<?php echo form_open('export/verify_code_export_excel', 'class="export" id="export_form"');?>
							<?php echo form_close(); ?>
							<!-- /.card-header -->
							<?php endif;?>
							<!-- /.card-header -->
								...
								<table id="report-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th width="120"><?php echo $this->lang->line('label_transaction_code');?></th>
											<th width="120"><?php echo $this->lang->line('label_username');?></th>
											<th width="120"><?php echo $this->lang->line('label_mobile');?></th>
											<th width="120"><?php echo $this->lang->line('label_code');?></th>
											<th width="120"><?php echo $this->lang->line('label_ip');?></th>
											<th width="120"><?php echo $this->lang->line('label_status');?></th>
											<th width="120"><?php echo $this->lang->line('label_remark');?></th>
											<th width="120"><?php echo $this->lang->line('label_response_data');?></th>
										</tr>
									</thead>
									<tbody></tbody>
								</table>
	...
	<script type="text/javascript">
		...
		function loadTable() {
			$('#report-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('report/verify_code_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
				...
				"columnDefs": [
					...
					<?php if(permission_validation(PERMISSION_PLAYER_MOBILE) == FALSE):?>
		...
		function exportData(){
			$.ajax({url: '<?php echo base_url("export/verify_code_export_excel_check");?>',
				type: 'get',								
				async: 'true',
				beforeSend: function() {
					layer.load(1);
