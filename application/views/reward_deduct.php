				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('reward/reward_deduct_submit', array('id' => 'player-form', 'name' => 'player-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									...
									<div class="form-group row">
										<label class="col-5 col-form-label"><?php echo $this->lang->line('label_reward_remaining');?></label>
										<div class="col-3">
											<label class="col-form-label font-weight-normal"><?php echo (isset($rewards) ? $rewards : '');?></label>
										</div>
									</div>
									<div class="form-group row">
										<label for="rewards" class="col-5 col-form-label">&nbsp;</label>
										<div class="col-3">
											<input type="text" class="form-control" id="rewards" name="rewards" value="">
										</div>
										<label class="col-4 col-form-label font-weight-normal">/ &nbsp; <?php echo (isset($rewards) ? $rewards : '0');?></label>
									</div>
									<div class="form-group row">
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									message = json.msg;
									msg_icon = 1;
									parent.$('#uc5_' + json.response.id).html(json.response.rewards);
									
									parent.layer.close(index);
								}
								else {
									if(json.msg.rewards_error != '') {
										message = json.msg.rewards_error;
									}
