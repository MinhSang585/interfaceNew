				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('deposit/update', array('id' => 'deposit-form', 'name' => 'deposit-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-3">
											<label class="col-form-label font-weight-normal"><?php echo (isset($amount) ? $amount : '');?></label>
										</div>
									</div>
									<?php if(isset($promotion_id) && !empty($promotion_id)){ ?>
									<div class="form-group row">
									...
									<?php if(isset($promotion_response['status']) && $promotion_response['status'] == STATUS_ALLOW){ ?>
									<div class="form-group row">
										<label class="col-5 col-form-label"><?php echo $this->lang->line('label_archieve_amount');?></label>
										<div class="col-3">
											<label class="col-form-label font-weight-normal"><?php echo (isset($promotion_response['result']['achieve_amount']) ? $promotion_response['result']['achieve_amount'] : '');?></label>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-5 col-form-label"><?php echo $this->lang->line('label_reward_amount');?></label>
										<div class="col-3">
											<label class="col-form-label font-weight-normal"><?php echo (isset($promotion_response['result']['reward_amount']) ? $promotion_response['result']['reward_amount'] : '');?></label>
										</div>
									</div>
									<?php }} ?>
									<div class="form-group row">
								...
								<div class="card-footer">
									...
									<input type="hidden" id="deposit_id" name="deposit_id" value="<?php echo (isset($deposit_id) ? $deposit_id : '');?>">
