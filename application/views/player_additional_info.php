				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('player/update_additional_info', array('id' => 'player-form', 'name' => 'player-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-7">
											<textarea class="form-control" id="additional_info" name="additional_info" rows="8"><?php echo (isset($additional_info) ? $additional_info : '');?></textarea>
										</div>
									</div>
								</div>
								<!-- /.card-body -->
