		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					<div class="col-12">
						<div class="card">
							<?php if(permission_validation(PERMISSION_BANNER_ADD) == TRUE):?>
							...
							<?php endif;?>
							<div class="card-body">
								<table id="banner-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											<th><?php echo $this->lang->line('label_hashtag');?></th>
											<th><?php echo $this->lang->line('label_banner_name');?></th>
											<th><?php echo $this->lang->line('label_sequence');?></th>
											<th><?php echo $this->lang->line('label_language');?></th>
											...
											<?php if(permission_validation(PERMISSION_BANNER_UPDATE) == TRUE OR permission_validation(PERMISSION_BANNER_DELETE) == TRUE):?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#banner-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('banner/listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function addData() {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_add_banner');?>',
				content: '<?php echo base_url('banner/add/');?>'
			});
		}
		...
		function updateData(id) {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_banner_setting');?>',
				content: '<?php echo base_url('banner/edit/');?>' + id
			});
		}
		...
		function deleteData(id) {
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('banner/delete/');?>' + id, function(data) {
