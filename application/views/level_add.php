				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open_multipart('level/submit', array('id' => 'level-form', 'name' => 'level-form', 'class' => 'form-horizontal'));?>
								<div class="card-body row">
												...
												<div class="form-group row">
													<div class="col-md-6 col-12">
														...
														<div class="form-group row">
															...
															<div class="col-7">
																<input type="number" class="form-control" id="level_number" name="level_number" value="">
															</div>
														</div>
														<div class="form-group row">
															<label for="level_reward_amount" class="col-5 col-form-label"><?php echo $this->lang->line('label_reward_amount');?></label>
															<div class="col-7">
																<input type="number" class="form-control" id="level_reward_amount" name="level_reward_amount" value="">
															</div>
														</div>
														<div class="form-group row">
														...
														<div class="form-group row">
															...
															<div class="col-7">
																<input type="number" class="form-control" id="monthly_phone_bill_rebate" name="monthly_phone_bill_rebate" value="">
															</div>
														</div>
													...
													<div class="col-md-6 col-12">
														...
														<div class="form-group row">
															...
															<div class="col-7">
																<input type="number" class="form-control" id="level_rate_<?php echo strtolower($game_type_row);?>" name="level_rate_<?php echo strtolower($game_type_row);?>" value="">
															</div>
														</div>
														<?php
																}
													...
													<div class="col-12">
														...
														<div class="tab-content" id="custom-content-below-tabContent">
															<div class="tab-pane fade show active" id="custom-content-below-upgrade" role="tabpanel" aria-labelledby="custom-content-below-upgrade-tab">
																...
																<div class="form-group row" style="display: none;"  id="upgrade_setting_from">
																	<div class="col-md-6 col-12"  id="upgrade_setting_deposit_amount_from" style="display: none;">
																		<div class="form-group row">
																			<label for="level_deposit_amount_from" class="col-5 col-form-label"><?php echo $this->lang->line('label_deposit_amount_from');?></label>
																			<div class="col-7">
																				<input type="number" class="form-control" id="level_deposit_amount_from" name="level_deposit_amount_from" value="">
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-12"  id="upgrade_setting_target_amount_from" style="display: none;">
																		<div class="form-group row">
																			<label for="level_target_amount_from" class="col-5 col-form-label"><?php echo $this->lang->line('label_target_amount_from');?></label>
																			<div class="col-7">
																				<input type="number" class="form-control" id="level_target_amount_from" name="level_target_amount_from" value="">
																			</div>
																		</div>
																	</div>
																</div>
																<div class="form-group row" style="display: none;" id="upgrade_setting_to">
																	<div class="col-md-6 col-12" id="upgrade_setting_deposit_amount_to" style="display: none;">
																		<div class="form-group row">
																			<label for="level_deposit_amount_to" class="col-5 col-form-label"><?php echo $this->lang->line('label_deposit_amount_to');?></label>
																			<div class="col-7">
																				<input type="number" class="form-control" id="level_deposit_amount_to" name="level_deposit_amount_to" value="">
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-12" id="upgrade_setting_target_amount_to" style="display: none;">
																		<div class="form-group row">
																			<label for="level_target_amount_to" class="col-5 col-form-label"><?php echo $this->lang->line('label_target_amount_to');?></label>
																			<div class="col-7">
																				<input type="number" class="form-control" id="level_target_amount_to" name="level_target_amount_to" value="">
																			</div>
																		</div>
																	</div>
																</div>
															...
															<div class="tab-pane fade" id="custom-content-below-downgrade" role="tabpanel" aria-labelledby="custom-content-below-downgrade-tab">
																...
																<div class="form-group row">
																	...
																	<div class="col-7">
																		<input type="number" class="form-control" id="maintain_membership_limit" name="maintain_membership_limit" value="">
																	</div>
																</div>
																<div class="form-group row" style="display: none;"  id="downgrade_setting">
																	<div class="col-md-6 col-12"  id="downgrade_setting_deposit_amount" style="display: none;">
																		<div class="form-group row">
																			...
																			<div class="col-7">
																				<input type="number" class="form-control" id="maintain_membership_deposit_amount" name="maintain_membership_deposit_amount" value="">
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-12"  id="downgrade_setting_target_amount" style="display: none;">
																		<div class="form-group row">
																			...
																			<div class="col-7">
																				<input type="number" class="form-control" id="maintain_membership_target_amount" name="maintain_membership_target_amount" value="">
																			</div>
																		</div>
																	</div>
																</div>
									...
									<div class="col-md-12 col-12">
										<div class="card card-secondary">
											<div class="card-header">
												<h3 class="card-title"><?php echo $this->lang->line('label_level_game_selection');?></h3>
											</div>
											<div class="card-body">
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									...
									if(json.msg.level_number_error != '') {
										message = json.msg.level_number_error;
									}
									else if(json.msg.upgrade_type_error != ''){
