								...
								<table id="report-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th width="180"><?php echo $this->lang->line('label_bet_amount');?></th>
											<th width="180"><?php echo $this->lang->line('label_rolling_amount');?></th>
											<th width="180"><?php echo $this->lang->line('label_win_loss');?></th>
											<th width="80"><?php echo $this->lang->line('label_rtp');?></th>
										</tr>
									</thead>
									<tbody></tbody>
									<tfoot>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#report-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('report/winloss_player_game_provider_daily_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
