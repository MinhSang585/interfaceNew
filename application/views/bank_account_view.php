		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					<div class="col-12">
						<div class="card">
							<?php if(permission_validation(PERMISSION_BANK_ACCOUNT_ADD) == TRUE):?>
							...
							<?php endif;?>
							<div class="card-body">
								<table id="bank_account-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<th><?php echo $this->lang->line('label_hashtag');?></th>
											<th width="200"><?php echo $this->lang->line('label_bank_name');?></th>
											<th width="150"><?php echo $this->lang->line('label_bank_account_name');?></th>
											<th width="100"><?php echo $this->lang->line('label_bank_account_no');?></th>
											<th width="100"><?php echo $this->lang->line('label_daily_limit');?></th>
											<th width="100"><?php echo $this->lang->line('label_group');?></th>
											...
											<?php if(permission_validation(PERMISSION_BANK_ACCOUNT_UPDATE) == TRUE OR permission_validation(PERMISSION_BANK_ACCOUNT_DELETE) == TRUE):?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#bank_account-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('bank/account_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function addData() {
			layer.open({
				...
				content: '<?php echo base_url('bank/account_add/');?>'
			});
		}
		...
		function updateData(id) {
			layer.open({
				...
				content: '<?php echo base_url('bank/account_edit/');?>' + id
			});
		}
		...
		function deleteData(id) {
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('bank/account_delete/');?>' + id, function(data) {
