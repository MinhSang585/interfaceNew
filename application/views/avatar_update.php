				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open_multipart('avatar/update', array('id' => 'avatar-form', 'name' => 'avatar-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row">
										<label for="avatar_name" class="col-5 col-form-label"><?php echo $this->lang->line('label_avatar_name');?></label>
										<div class="col-7">
											<input type="text" class="form-control" id="avatar_name" name="avatar_name" value="<?php echo (isset($avatar_name) ? $avatar_name : '');?>">
										</div>
									</div>
									<?php if(isset($avatar_image)):?>
									<div class="form-group row mt-3">
										<label class="col-5 col-form-label">&nbsp;</label>
										<div class="col-7">
											<a href="<?php echo AVATAR_SOURCE_PATH . $avatar_image;?>" target="_blank"><img src="<?php echo AVATAR_SOURCE_PATH . $avatar_image;?>" width="200" border="0" /></a>
										</div>
									</div>
									<?php endif;?>
									<div class="form-group row mt-3">
								...
								<div class="card-footer">
									<input type="hidden" id="avatar_id" name="avatar_id" value="<?php echo (isset($avatar_id) ? $avatar_id : '');?>">
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									message = json.msg;
									msg_icon = 1;
									parent.$('#uc1_' + json.response.id).html(json.response.avatar_name);
