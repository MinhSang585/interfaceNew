					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('seo/search');?>" id="seo-form" name="seo-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
									<div class="form-group row">
										<div class="col-md-3">
											...
											<div class="row mb-2">
												...
												<div class="col-8">
													<select class="form-control form-control-sm select2bs4 col-12" id="seo_id" name="seo_id">
							...
							<!-- /.card-header -->
							<?php if(permission_validation(PERMISSION_SEO_ADD) == TRUE):?>
							<div class="card-header">
							...
							<?php endif;?>
							<div class="card-body">
								<table id="seo-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											<th><?php echo $this->lang->line('label_hashtag');?></th>
											<th><?php echo $this->lang->line('label_name');?></th>
											<th><?php echo $this->lang->line('label_page_title');?></th>
											<th><?php echo $this->lang->line('label_domain_page');?></th>
											...
											<?php if(permission_validation(PERMISSION_SEO_UPDATE) == TRUE):?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#seo-table').DataTable({
				...
				"order": [[0, "asc"]],
				"ajax": {
					"url": "<?php echo site_url('seo/listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function addData() {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_add_seo');?>',
				content: '<?php echo base_url('seo/add/');?>'
			});
		}
		...
		function updateData(id) {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_seo_setting');?>',
				content: '<?php echo base_url('seo/edit/');?>' + id
			});
		}
		...
		function deleteData(id) {
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('seo/delete/');?>' + id, function(data) {
					var json = JSON.parse(JSON.stringify(data));
