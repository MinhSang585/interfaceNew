					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('reward/search');?>" id="reward-form" name="reward-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
							...
							<!-- /.card-header -->
							<div class="card-body">
								<table id="reward-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											...
											<th><?php echo $this->lang->line('label_amount_calculated');?></th>
											...
											<?php if(permission_validation(PERMISSION_REWARD_UPDATE) == TRUE):?>
									...
									<tfoot>
										<tr>
											...
											<th></th>
											<th></th>
											<?php if(permission_validation(PERMISSION_DEPOSIT_UPDATE) == TRUE):?>
											<th></th>
											<?php endif;?>
										</tr>
									</tfoot>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
					...
					$.ajax({url: form.attr('action'),
						...
						success: function (data) {
							...
							if(json.status == '<?php echo EXIT_SUCCESS;?>') {
								$('#reward-table').DataTable().ajax.reload();
							}
							else {
			...
			$('#reward-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('reward/listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function updateData(id) {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_reward_setting');?>',
				content: '<?php echo base_url('reward/edit/');?>' + id
			});
		}
	</script>	
</body>
