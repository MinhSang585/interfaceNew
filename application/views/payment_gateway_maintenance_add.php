				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('paymentgateway/maintenance_submit', array('id' => 'paymentgateway-form', 'name' => 'paymentgateway-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-7">
											<select class="form-control select2bs4 col-10" id="payment_gateway_id" name="payment_gateway_id">
												<option value=""><?php echo $this->lang->line('place_holder_payment_gateway_name');?></option>
												<?php
