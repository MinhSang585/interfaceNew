				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card">
							...
							<?php if(permission_validation(PERMISSION_MARQUEE_ADD) == TRUE):?>
							...
							<div class="card-body">
								...
								<table id="marquee-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									...
									<thead>
										...
										<tr>
											...
											<?php if(permission_validation(PERMISSION_MARQUEE_UPDATE) == TRUE OR permission_validation(PERMISSION_MARQUEE_DELETE) == TRUE):?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#marquee-table').DataTable({
				...
				"ajax": {
					...
					"url": "<?php echo site_url('marquee/listing');?>",
		...
		function addData() {
			...
			layer.open({
				...
				area: [((browser_width < 600) ? '100%': '1200px'), ((browser_width < 600) ? '100%': '850px')],
				...
				title: '<?php echo $this->lang->line('title_add_marquee');?>',

				content: '<?php echo base_url('marquee/add/');?>'
		...
		function updateData(id) {
			...
			layer.open({
				...
				area: [((browser_width < 600) ? '100%': '1200px'), ((browser_width < 600) ? '100%': '950px')],
				...
				title: '<?php echo $this->lang->line('title_marquee_setting');?>',

				content: '<?php echo base_url('marquee/edit/');?>' + id
		...
		function deleteData(id) {
			...
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('marquee/delete/');?>' + id, function(data) {
					...
					if(json.status == '<?php echo EXIT_SUCCESS;?>') {
						...
						$('#marquee-table').DataTable().ajax.reload();
