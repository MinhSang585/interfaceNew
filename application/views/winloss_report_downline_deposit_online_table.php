					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<div class="card-header">
								<label class="col-4 col-form-label col-form-label-sm font-weight-normal"><?php echo $this->lang->line('label_deposit_online');?></label>
							</div>
							<div class="card-body">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#deposit-table').DataTable({
				...
				"order": [[1, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('report/winloss_downline_deposit_online_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function loadTotal(){
			...
			$.ajax({url: '<?php echo base_url('report/winloss_downline_deposit_online_listing_total/');?>',
				type: 'get',                  
				async: 'true',
				beforeSend: function() {
				},
