				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('player/withdraw_submit', array('id' => 'player-form', 'name' => 'player-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<label class="col-4 col-form-label font-weight-normal">/ &nbsp; <?php echo (isset($points) ? $points : '');?></label>
									</div>
									<div class="form-group row">
