				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('bank/player_bank_image_save_update', array('id' => 'player_bank_image_save-form', 'name' => 'player_bank_image_save-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row">
										<label class="col-5 col-form-label"><?php echo $this->lang->line('label_username');?></label>
										<div class="col-7">
											<label class="col-form-label font-weight-normal"><?php echo (isset($created_by) ? $created_by : '-');?></label>
										</div>
									</div>
									<div class="form-group row">
										<label for="im_value" class="col-5 col-form-label"><?php echo $this->lang->line('label_type');?></label>
										<div class="col-7">
											<label class="col-form-label font-weight-normal"><?php echo (isset($player_bank_image_type) ? $this->lang->line(get_player_user_bank_type($player_bank_image_type)) : '-');?></label>
										</div>
									</div>
								</div>
								<!-- /.card-body -->
