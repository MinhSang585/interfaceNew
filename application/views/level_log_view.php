					...
					<div class="col-12">
						...
						<div class="card card-info">
							<div class="card-header">
								<label class="col-4 col-form-label col-form-label-sm font-weight-normal"><?php echo $this->lang->line('label_level_log');?></label>
							</div>
							<div class="card-body">
								<table id="report-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th><?php echo $this->lang->line('label_from_date');?></th>
											<th><?php echo $this->lang->line('label_to_date');?></th>
											<th><?php echo $this->lang->line('label_accumulate_deposit');?></th>
											<th><?php echo $this->lang->line('label_game_provider');?></th>
											<th><?php echo $this->lang->line('label_game_type');?></th>
											<th><?php echo $this->lang->line('label_accumulate_target');?></th>
											<th><?php echo $this->lang->line('label_level_from');?></th>
											<th><?php echo $this->lang->line('label_level_to');?></th>
											<th><?php echo $this->lang->line('label_movement');?></th>
											...
											<?php if(permission_validation(PERMISSION_LEVEL_LOG_UPDATE) == TRUE):?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#report-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('level/level_log_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function approveData(id) {
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('level/level_log_approve/');?>' + id, function(data) {
		...
		function rejectData(id) {
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('level/level_log_reject/');?>' + id, function(data) {
					var json = JSON.parse(JSON.stringify(data));
					var message = json.msg;
					var msg_icon = 2;
