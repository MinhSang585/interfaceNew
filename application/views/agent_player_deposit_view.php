					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('deposit/agent_player_deposit_search');?>" id="deposit-form" name="deposit-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
							...
							<div class="card-body" style="display:none;">
								<table id="deposit-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<th width="10"><?php echo $this->lang->line('label_hashtag');?></th>
											<th width="200"><?php echo $this->lang->line('label_date');?></th>
											<th width="150"><?php echo $this->lang->line('label_type');?></th>
											<th width="250"><?php echo $this->lang->line('label_player_username');?></th>
											<th width="150"><?php echo $this->lang->line('label_amount_apply');?></th>
											<th width="150"><?php echo $this->lang->line('label_status');?></th>
											<th width="300"><?php echo $this->lang->line('label_ip');?></th>
										</tr>
									</thead>
									<tbody></tbody>
									<tfoot>
	...
	<script type="text/javascript">
		...
		function loadTable(){
			$('#deposit-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('deposit/agent_player_deposit_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function loadTotal(){
			...
			$.ajax({url: '<?php echo base_url('deposit/agent_player_deposit_total/');?>',
				type: 'get',                  
				async: 'true',
				beforeSend: function() {
				},
