				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open_multipart('banner/submit', array('id' => 'banner-form', 'name' => 'banner-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row">
										<label for="banner_name" class="col-5 col-form-label"><?php echo $this->lang->line('label_banner_name');?></label>
										<div class="col-7">
											<input type="text" class="form-control col-10" id="banner_name" name="banner_name" value="">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-7">
											<input type="text" class="form-control col-3" id="banner_sequence" name="banner_sequence" value="" maxlength="3">
										</div>
									</div>
									<div class="form-group row">
										<label for="banner_url" class="col-5 col-form-label"><?php echo $this->lang->line('label_url');?></label>
										<div class="col-7">
											<input type="text" class="form-control col-10" id="banner_url" name="banner_url" value="">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="tab-content" id="custom-content-below-tabContent">
										<div class="tab-pane fade show active" id="custom-content-below-web" role="tabpanel" aria-labelledby="custom-content-below-web-tab">
											...
											<div class="form-group row">
												...
												<div class="col-2">
													<input type="text" class="form-control col-12" id="web_banner_width" name="web_banner_width" value="" maxlength="4">
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-2">
													<input type="text" class="form-control col-12" id="web_banner_height" name="web_banner_height" value="" maxlength="4">
												</div>
												<label class="col-5 col-form-label font-weight-normal">px</label>
											</div>
											<div class="form-group row">
												...
												<div class="col-7">
													<input type="text" class="form-control col-10" id="web_banner_alt" name="web_banner_alt" value="">
												</div>
											</div> 
										</div>
										<div class="tab-pane fade" id="custom-content-below-mobile" role="tabpanel" aria-labelledby="custom-content-below-mobile-tab">
											...
											<div class="form-group row">
												...
												<div class="col-2">
													<input type="text" class="form-control col-12" id="mobile_banner_width" name="mobile_banner_width" value="" maxlength="4">
												</div>
												<label class="col-5 col-form-label font-weight-normal">px</label>
											</div>
											<div class="form-group row">
												...
												<div class="col-2">
													<input type="text" class="form-control col-12" id="mobile_banner_height" name="mobile_banner_height" value="" maxlength="4">
												</div>
												<label class="col-5 col-form-label font-weight-normal">px</label>
											</div>
											<div class="form-group row">
												...
												<div class="col-7">
													<input type="text" class="form-control col-10" id="mobile_banner_alt" name="mobile_banner_alt" value="">
												</div>
											</div>
										</div>
									</div>
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									message = json.msg;
									msg_icon = 1;
									parent.$('#banner-table').DataTable().ajax.reload();
									parent.layer.close(index);
								}
								else {
