					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('report/point_agent_search');?>" id="report-form" name="report-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
							...
							<?php echo form_open('export/point_agent_export_excel', 'class="export" id="export_form"');?>
							<?php echo form_close(); ?>
							<!-- /.card-header -->
							<?php endif;?>
							<!-- /.card-header -->
	...
	<script type="text/javascript">
		...
		function loadTable() {
			$('#report-table').DataTable({
				...
				"pageLength" : 10,
				"ajax": {
					"url": "<?php echo site_url('report/point_agent_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function exportData(){
			$.ajax({url: '<?php echo base_url("export/point_agent_export_excel_check");?>',
				type: 'get',								
				async: 'true',
				beforeSend: function() {
					layer.load(1);
