					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('report/reward_search');?>" id="report-form" name="report-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
											...
											<div class="row mb-2">
												...
												<div class="col-8">
													<select class="form-control form-control-sm select2bs4 col-12" id="transfer_type" name="transfer_type">
														...
														<?php
															foreach(get_transfer_reward_type() as $k => $v)
															{
							...
							<?php echo form_open('export/reward_export_excel', 'class="export" id="export_form"');?>
							<?php echo form_close(); ?>
							<!-- /.card-header -->
							<?php endif;?>
							<!-- /.card-header -->
								...
								<table id="report-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th width="130"><?php echo $this->lang->line('label_reward_deducted');?></th>
											<th width="120"><?php echo $this->lang->line('label_reward_gained');?></th>
	...
	<script type="text/javascript">
		...
		function loadTable() {
			$('#report-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('report/reward_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function exportData(){
			$.ajax({url: '<?php echo base_url("export/reward_export_excel_check");?>',
				type: 'get',								
				async: 'true',
				beforeSend: function() {
					layer.load(1);
