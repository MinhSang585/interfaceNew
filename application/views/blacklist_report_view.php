					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('blacklist/report_search');?>" id="blacklist-form" name="blacklist-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
									<div class="form-group row">
										...
										<div class="col-md-3">
											...
											<div class="row mb-2">
												<label class="col-4 col-form-label col-form-label-sm font-weight-normal"><?php echo $this->lang->line('label_black_list_value');?></label>
												<div class="col-8">
								...
								<table id="blacklist-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											...
											<th><?php echo $this->lang->line('label_info');?></th>
											...
											<?php if(permission_validation(PERMISSION_BLACKLIST_REPORT_UPDATE) == TRUE):?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#blacklist-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo base_url('blacklist/report_listing/');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function updateData(id) {
			layer.open({
				...
				content: '<?php echo base_url('blacklist/report_edit/');?>' + id
			});
		}
	</script>	
</body>
