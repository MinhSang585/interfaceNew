					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
							  <form action="<?php echo site_url('bank/player_search');?>" id="bank_player-form" name="bank_player-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
								...
								<table id="bank_player-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<?php if(permission_validation(PERMISSION_PLAYER_BANK_IMAGE) == TRUE  OR permission_validation(PERMISSION_BANK_PLAYER_USER_UPDATE) == TRUE OR permission_validation(PERMISSION_BANK_PLAYER_USER_DELETE) == TRUE):?>
