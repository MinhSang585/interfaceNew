					...
					<div class="col-12">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<form action="<?php echo site_url('paymentgateway/limited_search');?>" id="paymentgateway-form" name="paymentgateway-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
							...
							<?php if(permission_validation(PERMISSION_PAYMENT_GATEWAY_LIMITED_ADD) == TRUE):?>
								...
								<table id="payment_gateway-table" class="table table-striped table-bordered table-hover">
									...
									<thead>
										...
										<tr>
											...
											<th width="120"><?php echo $this->lang->line('label_sequence');?></th>

											<th width="120"><?php echo $this->lang->line('label_per_limit');?></th>

											<th width="170"><?php echo $this->lang->line('label_current_usage');?></th>

											<th width="120"><?php echo $this->lang->line('label_status');?></th>

											<th width="150"><?php echo $this->lang->line('label_updated_by');?></th>

											<th width="150"><?php echo $this->lang->line('label_updated_date');?></th>

											<?php if(permission_validation(PERMISSION_PAYMENT_GATEWAY_LIMITED_UPDATE) == TRUE || permission_validation(PERMISSION_PAYMENT_GATEWAY_LIMITED_DELETE) == TRUE):?>
	...
	<script type="text/javascript">
		...
		function loadTable(){
			...
			$('#payment_gateway-table').DataTable({
				...
				"ajax": {
					...
					"url": "<?php echo site_url('paymentgateway/limited_listing');?>",
		...
		function addData() {
			...
			layer.open({
				...
				title: '<?php echo $this->lang->line('title_add_payment_gateway_limited');?>',

				content: '<?php echo base_url('paymentgateway/limited_add/');?>'
		...
		function updateData(id) {
			...
			layer.open({
				...
				title: '<?php echo $this->lang->line('title_payment_gateway_limited_setting');?>',

				content: '<?php echo base_url('paymentgateway/limited_edit/');?>' + id
		...
		function deleteData(id) {
			...
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('paymentgateway/limited_delete/');?>' + id, function(data) {
