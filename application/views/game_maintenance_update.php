				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('game/maintenance_update', array('id' => 'game-form', 'name' => 'game-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
								...
								<div class="card-footer">
									<input type="hidden" id="game_maintenance_id" name="game_maintenance_id" value="<?php echo (isset($game_maintenance_id) ? $game_maintenance_id : '');?>">
						...
						$.ajax({url: form.attr('action'),
							...
							success: function (data) {
								...
								if(json.status == '<?php echo EXIT_SUCCESS;?>') {
									message = json.msg;
									msg_icon = 1;
									parent.$('#uc1_' + json.response.id).html(json.response.game_sequence);
