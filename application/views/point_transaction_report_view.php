					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<form action="<?php echo site_url('report/point_search');?>" id="report-form" name="report-form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
							...
							<?php echo form_open('export/point_export_excel', 'class="export" id="export_form"');?>
							<?php echo form_close(); ?>
							<!-- /.card-header -->
							<?php endif;?>
							<!-- /.card-header -->
								...
								<table id="report-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th width="120"><?php echo $this->lang->line('label_account_out');?></th>
											<th width="120"><?php echo $this->lang->line('label_account_in');?></th>
	...
	<script type="text/javascript">
		...
		function loadTable() {
			$('#report-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('report/point_listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function exportData(){
			$.ajax({url: '<?php echo base_url("export/point_export_excel_check");?>',
				type: 'get',								
				async: 'true',
				beforeSend: function() {
					layer.load(1);
