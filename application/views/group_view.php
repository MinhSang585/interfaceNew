				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<?php endif;?>
							<div class="card-body">
								<table id="group-table" class="table table-striped table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											<th><?php echo $this->lang->line('label_hashtag');?></th>
											<th><?php echo $this->lang->line('label_group_name');?></th>
											<th><?php echo $this->lang->line('label_group_type');?></th>
											...
											<?php if(permission_validation(PERMISSION_GROUP_UPDATE) == TRUE OR permission_validation(PERMISSION_GROUP_DELETE) == TRUE):?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#group-table').DataTable({
				...
				"order": [[0, "desc"]],
				"ajax": {
					"url": "<?php echo site_url('group/listing');?>",
					"dataType": "json",
					"type": "POST",
					"data": function (d) {
		...
		function addData() {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_add_group');?>',
				content: '<?php echo base_url('group/add/');?>'
			});
		}
		...
		function updateData(id) {
			layer.open({
				...
				maxmin: true,
				scrollbar: false,
				title: '<?php echo $this->lang->line('title_group_setting');?>',
				content: '<?php echo base_url('group/edit/');?>' + id
			});
		}
		...
		function deleteData(id) {
			layer.confirm('<?php echo $this->lang->line('label_confirm_to_proceed');?>', {
				...
				$.get('<?php echo base_url('group/delete/');?>' + id, function(data) {
