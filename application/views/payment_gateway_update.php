								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-7">
											...
											<input type="checkbox" id="payment_gateway_active" name="payment_gateway_active" value="1" <?php echo ((isset($active) && $active == STATUS_YES) ? 'checked' : '');?> data-bootstrap-switch data-off-color="secondary" data-on-color="success">
