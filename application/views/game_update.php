				...
				<div class="row">
					...
					<div class="col-12">
						...
						<div class="card card-primary">
							<!-- form start -->
							<?php echo form_open('game/update', array('id' => 'game-form', 'name' => 'game-form', 'class' => 'form-horizontal'));?>
								<div class="card-body">
									<div class="form-group row">
										<label class="col-5 col-form-label"><?php echo $this->lang->line('label_name');?></label>
										<div class="col-7">
											<label class="col-form-label font-weight-normal"><?php echo (isset($game_name) ? $this->lang->line($game_name) : '');?></label>
										</div>
									</div>
									<div class="form-group row">
								...
								<div class="card-footer">
									<input type="hidden" id="game_id" name="game_id" value="<?php echo (isset($game_id) ? $game_id : '');?>">
