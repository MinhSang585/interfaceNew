...
defined('PERMISSION_PAYMENT_GATEWAY_ADD')		OR define('PERMISSION_PAYMENT_GATEWAY_ADD',319);
defined('PERMISSION_PAYMENT_GATEWAY_DELETE')		OR define('PERMISSION_PAYMENT_GATEWAY_DELETE',320);
...
defined('LOG_PAYMENT_GATEWAY_ADD')		OR define('LOG_PAYMENT_GATEWAY_ADD', 166);
defined('LOG_PAYMENT_GATEWAY_DELETE')		OR define('LOG_PAYMENT_GATEWAY_DELETE', 167);
