...
class Role_model extends CI_Model
{
	...
	} /**	*  Get role list by level	* if the user account login, his role is level 2, then he only able select level 3 role character when create sub account/user	* @param integer $user_role_id	* @return array $result role list	*/
