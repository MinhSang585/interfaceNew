...
class Payment_gateway_model extends CI_Model {
	...
	public function get_payment_gateway_data($id = NULL, $isNewBO = NULL)
	...
	public function get_all_payment_gateway_data($id = NULL)
	...
	{	
		...
		$DBdata = array(
			...
			//'api_data' => $this->input->post('api_data', TRUE),
			//'bank_data' => $this->input->post('bank_data', TRUE),
			'payment_gateway_code' =>$this->input->post('payment_gateway_code', TRUE),
			//'payment_gateway_name' => $this->input->post('payment_gateway_name', TRUE),
			'active' => (($this->input->post('payment_gateway_active', TRUE) == STATUS_YES) ? STATUS_YES : STATUS_NO),
		);
	...
	public function insert_payment_gateway()
	{	
		log_message('error', print_r('insert_payment_gateway', true));
		$payment_gateway_name = trim($this->input->post('		', TRUE));
		log_message('error', print_r($payment_gateway_name, true));
		log_message('error', print_r(trim($this->input->post('payment_gateway_name', TRUE)), TRUE));

		$DBdata = array(
			'payment_gateway_name' => $this->input->post('payment_gateway_name', TRUE),
			'payment_gateway_code' =>$this->input->post('payment_gateway_code', TRUE),
			'active' => $this->input->post('payment_gateway_active', TRUE),
			'payment_gateway_sequence' => $this->input->post('payment_gateway_sequence', TRUE),
			'payment_gateway_admin_verification' => (($this->input->post('payment_gateway_admin_verification', TRUE) == STATUS_YES) ? STATUS_YES : STATUS_NO),
			'payment_gateway_rate_type' => $this->input->post('payment_gateway_rate_type', TRUE),
			'payment_gateway_rate' => $this->input->post('payment_gateway_rate', TRUE),
	...
	public function delete_payment_gateway($id = NULL)
	{	
		$this->db->where('payment_gateway_id', $id);
		$this->db->limit(1);
