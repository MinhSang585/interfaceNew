...
$config['licenseName'] = '8EB6AF82KAA';
$config['licenseKey']  = '*Z?2-*1**-2**T-*3**-*J**-S*A*-3**J';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://rrrbets.com/uploads/hub/',
    'root'         =>  '../../../../../../.././uploads/hub/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
