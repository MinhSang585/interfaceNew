...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _handleRotation: function ($el, $content, angle) {
            ...
            if($el[0].className != "file-zoom-dialog modal fade rotatable show"){
                $('.image_src_destination_value').val($content[0].src);
                $('.image_src_destination_alt').val($content[0].alt);
                $('.image_rotate_value').val(angle);
                $('.image_rotate_btn').click();
            }
